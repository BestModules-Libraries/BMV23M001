/*****************************************************************
File:        example01_getFWVerWithIIC.ino 
...
BMV23M001 soundDetector(&Wire);//Please comment out this line of code if you don't use Wire
//BMV23M001 soundDetector(&Wire1);//Please uncomment out this line of code if you use Wire1 on BMduino
//BMV23M001 soundDetector(&Wire2);//Please uncomment out this line of code if you use Wire2 on BMduino
uint16_t verNum = 0;
