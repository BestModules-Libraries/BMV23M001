...
uint8_t BMV23M001::readSoundStatus()
{
    ...
    checkSum = (uint8_t)(0xA5+0x5A+0x03+0x01);
    uint8_t soundCMD[5]={0xA5,0x5A,0x03,0x01,checkSum};
...
uint16_t BMV23M001::readSoundEnvelopeADC( )
{
    ...
    checkSum = (uint8_t)(0xA5+0x5A+0x03+0x02);
    uint8_t ADCCMD[5]={0xA5,0x5A,0x03,0x02,checkSum};
    writeBytes(ADCCMD,5);
